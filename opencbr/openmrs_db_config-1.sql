...
VALUES
  ('casereport.organisationOID', '2.16.840.1.113883.3.7194.1.101', 'Identifier of the entity that submits case report
  documents, MUST be an OID, please refer to the module documentation for the constraints around the allowed values.', UUID()),
  ('casereport.organisationExtension', 'DEMO1', 'Extension of the entity that submits case report documents', UUID()),
  ('casereport.organisationName', 'Demo 1', 'Name of the entity that submits case report documents', UUID()),
