...
SET universal_identifier_type_code = 'ISO', universal_identifier = '2.16.840.1.113883.3.7194.2.2'
...
VALUES(81, 'OpenMRS Old ID', 'Number given out prior to the OpenMRS system (No check digit)', '2.16.840.1.113883.3.7194.2.1', 'ISO', 'OpenMRS Old ID', current_timestamp, -1),
      (82, 'OpenMRS ID', 'OpenMRS patient identifier, with check-digit', '2.16.840.1.113883.3.7194.2.3', 'ISO', 'OpenMRS ID', current_timestamp, -1);
